...
les branches pour les bugs avec qa 

main et master conflict avec github

3 points :

-les compétitions passé peuvent pas reserver enlever le boutton

-nb de points de chaquez club afficher sur la page web pas en endpoints

-limite des 12 places limite de points qu'on a sur toutes les réservation du clubs
(acumule dans la même variable) ou 1 object par réservation pour ne pas dépasser 12

faire chaque bug sur une branch ensuite merge le tous sur la branche qa puis merge dans main
qa -> branche -> merge 
qa -> branche -> merge 

pour les bugs nomenclature bug (slash) nom

sofien.benayed@gmail.com